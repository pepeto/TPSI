...
def SVC2(X_train, y_train, X_test, y_test):
    ...
    svc_clf = Pipeline((
        ...
        ("svm_clf", SVC(C=4.55, kernel="rbf", degree=4, gamma=17.53))
    ))
    '''

    svc_clf = SVC(C=1.61, kernel="poly", degree=1, gamma=5778.85108)
    ...
    print("\nSVC2 (4 fold) Std Dev: %5.2f - Mean Acc: %5.2f - Elap: %5.2f seg\n" %
